...
from postreh.config import SUNSET_MAIN_COLOR1, SUNSET_MAIN_CYCLES, SUNSET_MAIN_PERIOD, SUNSET_NUMBERS_CYCLES, SUNSET_NUMBERS_PERIOD, SUNSET_WAIT_SLEEP, SUNSET_WAIT_SLEEP_LIMIT
import utime
...
from postreh.effects import Pulse2, Fadeout
from postreh.config import SUNSET_MAIN_PERIOD, SUNSET_MAIN_COLOR1, SUNSET_MAIN_CYCLES, SUNSET_NUMBERS_PERIOD, SUNSET_NUMBERS_CYCLES, SUNSET_WAIT_SLEEP, SUNSET_WAIT_SLEEP_LIMIT
...
def process(tick, context):
    ...
    if tick == 0:
        ...
        main = Pulse2(SUNSET_MAIN_PERIOD, SUNSET_MAIN_COLOR1, BLACK, SUNSET_MAIN_CYCLES, fadeout=True, led_fn=LED_MAIN.fill)
        # cisla se skore pomalu zhasnou
        numbers = Fadeout(SUNSET_NUMBERS_PERIOD, SUNSET_NUMBERS_CYCLES, LED_NUMBERS)
        # reset hodnot
        internal_state = None
        next_state = 'wait'
        internal_tick = 0
