...
from postreh.config import WIN_MAIN_PERIOD, WIN_MAIN_COLOR1, WIN_MAIN_COLOR2, WIN_MAIN_CYCLES, WIN_NUMBER_PERIOD, WIN_NUMBER_COLOR1, WIN_NUMBER_COLOR2, WIN_NUMBER_CYCLES, WIN_WAIT_SLEEP, WIN_WAIT_SLEEP_LIMIT
...
def process(tick, context):
    ...
    if tick == 0:
        ...
        main = Pulse2(WIN_MAIN_PERIOD, WIN_MAIN_COLOR1, WIN_MAIN_COLOR2, WIN_MAIN_CYCLES, led_fn=LED_MAIN.fill)
        # hraci zablika nove ziskane skore
        number = Pulse2(WIN_NUMBER_PERIOD, WIN_NUMBER_COLOR1, WIN_NUMBER_COLOR2, WIN_NUMBER_CYCLES, led_fn=lambda c: LED_NUMBERS.set(context['last_player'] * 9 + context['score'][context['last_player']] - 1, c))
        # reset hodnot
        internal_state = None
        internal_tick = 0
        next_state = 'wait'
        ...
        if internal_tick >= WIN_WAIT_SLEEP_LIMIT:
            ...
            main = Pulse2(WIN_MAIN_PERIOD, WIN_MAIN_COLOR2, BLACK, WIN_MAIN_CYCLES, fadeout=True, led_fn=LED_MAIN.fill)
            internal_state = None
            next_state = 'done'
